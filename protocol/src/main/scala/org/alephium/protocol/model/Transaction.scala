...
import org.oxyg3nium.protocol.model.Transaction.MerkelTx
import org.oxyg3nium.protocol.vm.LockupScript
import org.oxyg3nium.serde._
import org.oxyg3nium.util.{AVector, Duration, Hex, Math, TimeStamp, U256}
...
object Transaction {
  ...
  def powCoinbaseForTest(
    ...
    val powReward = consensusConfig.emission
      .reward(target, blockTs, OXM.LaunchTimestamp)
