        ...
        case (
          ...
          c.Expr[Any](
            q"""final case class $className $mods ( ..$fields ) extends ..$parents {
              lazy val bytes: akka.util.ByteString = org.oxyg3nium.serde.serialize(this)
              lazy val hash: org.oxyg3nium.protocol.Hash = org.oxyg3nium.protocol.Hash.hash(bytes)
