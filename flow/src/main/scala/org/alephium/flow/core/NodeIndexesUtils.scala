...
import org.oxyg3nium.protocol.model.{BlockHash, ContractId, TxOutput, TxOutputRef}
import org.oxyg3nium.protocol.vm.nodeindexes.{TxIdTxOutputLocators, TxOutputLocator}
import org.oxyg3nium.protocol.vm.subcontractindex.SubContractIndexStateId
