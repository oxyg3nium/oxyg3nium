...
import org.oxyg3nium.flow.{Utils => FlowUtils}
...
import org.oxyg3nium.flow.network.interclique.{InboundBrokerHandler, OutboundBrokerHandler}
...
object InterCliqueManager {
  ...
  val peersTotal: Gauge = Gauge
    .build("oxyg3nium_peers_total", "Number of connected peers")
    .register()
