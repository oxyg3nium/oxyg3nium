...
import org.oxyg3nium.util.{Oxyg3niumFixture, Oxyg3niumSpec, AVector}

class TypeSpec extends Oxyg3niumSpec {
...
trait TypeSignatureFixture extends Oxyg3niumFixture {
  val contractStr =
    s"""
       |struct Account {
       |  amount: U256,
