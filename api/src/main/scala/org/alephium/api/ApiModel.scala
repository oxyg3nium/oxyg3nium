...
import org.oxyg3nium.json.Json.{ReadWriter => RW}
...
import org.oxyg3nium.protocol.vm.{GasBox, GasPrice, StatefulContract}
import org.oxyg3nium.serde.{deserialize, serialize, RandomBytes}
