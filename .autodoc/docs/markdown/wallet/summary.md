[View code on GitHub](https://github.com/oxyg3nium/oxyg3nium/.autodoc/docs/json/wallet)

The `wallet` folder in the Oxyg3nium project is responsible for managing wallets, addresses, balances, and transactions. It provides a convenient and type-safe way for users to interact with their wallets and the Oxyg3nium blockchain.
