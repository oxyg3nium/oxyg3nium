[View code on GitHub](https://github.com/oxyg3nium/oxyg3nium/.autodoc/docs/json/http/src/main)

The `.autodoc/docs/json/http/src/main` folder contains essential components for handling HTTP requests and responses in the Oxyg3nium project. It includes classes for sending requests to endpoints, configuring server options, and serving a Swagger UI for API documentation.
